...
<template>
  <div class="container">
    ...
    <div class="mb-3">
      ...
      />
      <input
        v-model.number="newProduct.image"
        placeholder="URL imagen"
        class="form-control mb-2"
      />
      <input
        v-model.number="newProduct.description"
    ...
    <div v-if="editing" class="mt-4">
      ...
      <input
        ...
        class="form-control mb-2"
      />
      <input v-model="editData.image" class="form-control mb-2" />
      <input v-model="editData.description" class="form-control mb-2" />
